  ...
  (
    <section id="services" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        Add your new hires to our payroll in a few simple steps, and manage all their information centrally.
        Administer employees' information and records.
        Choose how you want to pay your employees.
        Manage your employee exit process.We'll help you make accurate tax deductions along with tax-ready reports.
        </p>
