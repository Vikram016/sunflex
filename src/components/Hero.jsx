    ...
    flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <p className={`${styles.paragraph} ml-2`}>
          ...
          <span className="text-white">Power
            Solutions.</span> 
        </p>
      </div>
      ...
      justify-between items-center w-full">
        ...
        leading-[75px]">
          Welcome to  <br className="sm:block
          hidden" /> {" "}
          <span  
          className="text-gradient">Sunflex
          </span> {" "} 
        </h1>
      ...
      <h1 className="font-poppins font-semibold 
        ...
        leading-[75px] w-full"> Global Energy </h1>

        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          At Sunflex Global Energy, we are committed to pioneering in the field of clean energy 
          and innovative solutions. Our team of experts is passionate about creating a sustainable future, 
          and we have a track record of successful partnerships and client satisfaction.
